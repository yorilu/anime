;require.config({
  ...
  paths: {
    ...
    'BezierPlugin':[
        //'//cdn.bootcss.com/gsap/latest/plugins/BezierPlugin.min',
        'BezierPlugin.min'
    ],
	'EasePack': [
    ...
    'AttrPlugin': [
        //'//cdn.bootcss.com/gsap/latest/plugins/AttrPlugin.min',
        'AttrPlugin.min'
    ],
      'TextPlugin': [
        //'//cdn.bootcss.com/gsap/latest/plugins/TextPlugin.min',
        'TextPlugin.min'
      ]
  },
  shim: {
